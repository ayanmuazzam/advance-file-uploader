																...
																foreach ($extendons_upload_file_cart_item['extendons_upload_file_data'][$rule_id_index][$index_key]['uploaded_file'] as $keyval => $session_value) {
																	...
																	?>
																		<tr class="extendons-image-list">
																			...
																			<td><span style="display:inline-flex;cursor:pointer;">
																				...
																				<button type="button" index_key ="<?php echo filter_var($index_key); ?>" data-proid="<?php echo filter_var($productid); ?>" datapostid="<?php echo filter_var($extendons_upload_files_postid); ?>" rule_id_index="<?php echo filter_var($rule_id_index); ?>"  index="<?php echo filter_var($keyval); ?>" class="extendons_delete_ccta_file" delete_cart_key="<?php echo filter_var($cart_key); ?>" style="background-color: white;padding: unset;"><img src="https://cdn.iconscout.com/icon/premium/png-256-thumb/delete-1432400-1211078.png" width="30"></button></span>
																			</td>
																		</tr>
																	<?php
																}
