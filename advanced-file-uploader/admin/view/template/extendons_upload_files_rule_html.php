			...
			<div class="panel-body">
				...
				<div class="row">
					<div class="col-xs-4 col-md-3" style="margin-top: 20px;">
						...
						<input type="checkbox" name="extendons_uf_required[]" class="extendons_vt_checkboxes"><br>
						<label id="extendons_upload_files_label"><?php echo esc_html__('Allow Upload Modification:', 'extendons_Upload_Files'); ?><span class="tip" style="float: right;"><?php echo filter_var( wc_help_tip('Enable to Allow Customer to Modify Uploaded File' )); ?></span></label>
						<input type="checkbox" name="extendons_uf_allow_modification[]" class="extendons_vt_checkboxes">
					</div>
					<div class="col-xs-4 col-md-3" style="margin-top: 20px;">
