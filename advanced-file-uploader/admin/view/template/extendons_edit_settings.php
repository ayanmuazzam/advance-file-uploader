											...
											<div class="panel-body">
												...
												<div class="row">
													<div class="col-xs-4 col-md-3" style="margin-top: 20px;">
														...
														<input type="checkbox" <?php checked('true', $value['extendons_uploadfiles_file_allow_modification'] ?? 'false'); ?>  name="extendons_uf_allow_modification[]" class="extendons_vt_checkboxes">
													</div>
